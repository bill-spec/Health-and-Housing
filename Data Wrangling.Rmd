...
```{r}
houseOwnership <- read.csv("C:/Users/Billy/Desktop/1223/housingrentown (1).csv")

houseOwnership <- houseOwnership %>% 
    mutate(tract = as.integer(tract*100))

housingPoor <- read.csv("C:/Users/Billy/Desktop/1223/poorhousingconditions.csv")
housingVacant <- read.csv("C:/Users/Billy/Desktop/1223/vacantpropusps2016q2.csv")
...
childrenLead <- read.csv("C:/Users/Billy/Desktop/1223/Children Lead.csv")
childrenLead <- tractToInt(childrenLead)

anxiety <- read.csv("C:/Users/Billy/Desktop/1223/Anxiety.csv")
depression <- read.csv("C:/Users/Billy/Desktop/1223/Depression.csv")
diabetes <- read.csv("C:/Users/Billy/Desktop/1223/diabetes_all_2016.csv")
hypertension <- read.csv("C:/Users/Billy/Desktop/1223/Hypertension.csv")

#asthmaUse <- read.csv("C:/Users/Billy/Desktop/1223/dataset_asthma-2017 (1).csv")
#easthmaUse <- tractToInt(asthmaUse)
