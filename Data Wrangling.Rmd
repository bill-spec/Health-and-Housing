...
dataSet <- cbind(regSmall, "Observation.Number" = c(1:387))
...
```{r}
regSmall2 <- regSmall %>% rownames_to_column()
regSmall2 <- regSmall2 %>% dplyr::select(-anxietyMalePorportion,-anxietyFemalePorportion,-depressionMalePorportion,-depressionFemalePorportion,-hyperFemalePorportion,-hyperMalePorportion,-hyperPorportion,-hyper2MalePorportion,-hyper2FemalePorportion,-DiaPorportion,-DiaFemalePorportion,-DiaMalePorportion,-Dia2MalePorportion,-Dia2FemalePorportion)
regSmall2 <- regSmall2 %>% column_to_rownames(var = "rowname")
dataSetSmall <- cbind(regSmall2, "Observation.Number" = c(1:387))
```


```{r}
write.csv(dataSet, file = "C:/Users/Billy/Desktop/1223 Dataset/dataSet.csv")
write.csv(dataSetSmall, file = "C:/Users/Billy/Desktop/1223 Dataset/dataSetSmall.csv")
```
